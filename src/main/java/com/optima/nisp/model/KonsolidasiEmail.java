...
@NISPEntity(tableName="BO_TBL_KONSOLIDASI_EMAIL", dbSchema = CommonCons.DB_SCHEMA)
public class KonsolidasiEmail implements Serializable {

	private static final long serialVersionUID = -3714419757423401780L;
