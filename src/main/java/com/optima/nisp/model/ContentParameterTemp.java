...
@NISPEntity(tableName="BO_TBL_CONTENT_PARAM_TEMP", dbSchema=CommonCons.DB_SCHEMA)
public class ContentParameterTemp implements Serializable {

	private static final long serialVersionUID = -4738121775079084299L;
