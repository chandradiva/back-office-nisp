...
@NISPEntity(tableName = "BO_TBL_RIWAYAT_TRANS_PARAM", dbSchema = CommonCons.FE_DB_SCHEMA)
public class RiwayatTransaksiParameter implements Serializable {

	private static final long serialVersionUID = 830356767376908954L;
