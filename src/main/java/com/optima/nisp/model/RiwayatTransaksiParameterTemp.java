...
@NISPEntity(tableName = "BO_TBL_RIWAYAT_TRANS_PARAM_TMP", dbSchema = CommonCons.FE_DB_SCHEMA)
public class RiwayatTransaksiParameterTemp implements Serializable {

	private static final long serialVersionUID = 3593471097331147523L;
