...
@NISPEntity(tableName="BO_TBL_APP_PARAM_TEMP", dbSchema=CommonCons.FE_DB_SCHEMA)
public class ApplicationParameterTemp implements Serializable {

	private static final long serialVersionUID = -1097332961691412493L;
