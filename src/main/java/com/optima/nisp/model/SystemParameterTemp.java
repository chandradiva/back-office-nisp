...
@NISPEntity(tableName="BO_TBL_SYS_PARAM_TEMP", dbSchema=CommonCons.DB_SCHEMA)
public class SystemParameterTemp implements Serializable {

	private static final long serialVersionUID = 3910021960333985203L;
