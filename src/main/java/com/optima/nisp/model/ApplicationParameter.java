...
@NISPEntity(tableName="BO_TBL_APP_PARAM", dbSchema=CommonCons.FE_DB_SCHEMA)
public class ApplicationParameter implements Serializable {

	private static final long serialVersionUID = 6115879582442331481L;
	...
	@NISPEntitySerialize(field = "VALUE_TYPE")
	@NISPEntity(columnName = "VALUE_TYPE")
