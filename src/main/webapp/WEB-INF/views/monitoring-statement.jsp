...
<script>
    ...
    $(document).ready(function(){    	
        document.title = "Monitoring Statement";
    ...
    function openFile(sendEmailId){
    	...
    	var ajax = $.ajax({
    		url: "<c:url value='send-email/open-file?id="+sendEmailId+"&isReprint=1' />",
    		type: 'GET'
    	});
    ...
    function setPrevNextBtnEvent(){
        ...
        $(".last-btn-pagination").off().on("click", function(){
            if($(this).hasClass("disabled") == false){
                ...
                refreshTable(cifKey, accountNumber, periode, status, gLastPage, totalPerPage, getAllCheckedStatus());
