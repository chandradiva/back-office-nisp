...
<h4>Review Laporan Konsolidasi Parameter</h4>
<br />
...
<div id="div-info" class="alert alert-info">
    ...
    <script>
    		var ajax = $.ajax({
                    url: "<c:url value='/consol-report-param/set-notif-off'/>",
                    timeout: 30000,
                    type : "PUT"
                });
...
<script>
	$(document).ready(function(){
        document.title = "Review Laporan Konsolidasi Parameter";
	...
	function refreshTable(){
        ...
        var ajax = $.ajax({
                        url: "<c:url value='/consol-report-param/get-unapproved' />",            
                        timeout : 30000,
                        type : 'get'
                    });
    ...
    function approveParams(){
    	...
    	if(status){
    		...
    		var ajax = $.ajax({
                    url: "<c:url value='/consol-report-param/approve'/>",
                    timeout: 30000,
                    type : "PUT",
                    dataType: "json",
                });
    ...
    function rejectParams(){
    	...
    	if(status){
    		$("#divLoadingBo").addClass("show");
    		var ajax = $.ajax({
                    url: "<c:url value='/consol-report-param/reject'/>",
                    timeout: 30000,
                    type : "PUT",
                    dataType: "json",
                });
