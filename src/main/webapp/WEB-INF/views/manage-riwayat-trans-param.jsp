...
<h4>Riwayat Transaksi Parameter</h4>
<br />
...
<script>
    $(document).ready(function(){
        document.title = "Manage Riwayat Transaksi Parameters";
    ...
    function refreshAppParamsTable(){
        var ajax = $.ajax({
                        url: "<c:url value='/riwayat-trans-param/get' />",            
                        timeout : 30000,
                        type : 'get'
                    });
        ...
        $(".save-appparams-btn").off().on("click", function(){
            ...
            if(applicationParameters.length>0){      
                ...
                if(status){
                    ...
                    var ajax = $.ajax({
                        url: "<c:url value='/riwayat-trans-param/update'/>",
                        timeout: 30000,
                        type : "PUT",
    ...
    function cancelRequestButtonEvent(){
        $(".cancel-request-btn").off().on("click", function(){
            ...
            if(status){
            	$("#divLoadingBo").addClass("show");
                var ajax = $.ajax({
                    url: "<c:url value='/riwayat-trans-param/cancel'/>",
                    timeout: 30000,
                    type : "PUT"
                });
                ajax.done(function (response) {
