...
<h4>Laporan Konsolidasi Parameter</h4>
<br />
...
<script>
    $(document).ready(function(){
        document.title = "Manage Laporan Konsolidasi Parameters";
    ...
    function refreshAppParamsTable(){
        var ajax = $.ajax({
                        url: "<c:url value='/consol-report-param/get' />",            
                        timeout : 30000,
                        type : 'get'
                    });
        ...
        $(".save-appparams-btn").off().on("click", function(){
            ...
            if(applicationParameters.length>0){      
                ...
                if(status){
                    ...
                    var ajax = $.ajax({
                        url: "<c:url value='/consol-report-param/update'/>",
                        timeout: 30000,
                        type : "PUT",
    ...
    function cancelRequestButtonEvent(){
        $(".cancel-request-btn").off().on("click", function(){
            ...
            if(status){
            	$("#divLoadingBo").addClass("show");
                var ajax = $.ajax({
                    url: "<c:url value='/consol-report-param/cancel'/>",
                    timeout: 30000,
                    type : "PUT"
                });
                ajax.done(function (response) {
