...
<h4>Review Riwayat Transaksi Parameter</h4>
<br />
...
<div id="div-info" class="alert alert-info">
    ...
    <script>
    		var ajax = $.ajax({
                    url: "<c:url value='/riwayat-trans-param/set-notif-off'/>",
                    timeout: 30000,
                    type : "PUT"
                });
...
<script>
	$(document).ready(function(){
        document.title = "Review Riwayat Transaksi Parameter";
	...
	function refreshTable(){
        ...
        var ajax = $.ajax({
                        url: "<c:url value='/riwayat-trans-param/get-unapproved' />",            
                        timeout : 30000,
                        type : 'get'
                    });
    ...
    function approveParams(){
    	...
    	if(status){
    		...
    		var ajax = $.ajax({
                    url: "<c:url value='/riwayat-trans-param/approve'/>",
                    timeout: 30000,
                    type : "PUT",
                    dataType: "json",
                });
    ...
    function rejectParams(){
    	...
    	if(status){
    		$("#divLoadingBo").addClass("show");
    		var ajax = $.ajax({
                    url: "<c:url value='/riwayat-trans-param/reject'/>",
                    timeout: 30000,
                    type : "PUT",
                    dataType: "json",
                });
