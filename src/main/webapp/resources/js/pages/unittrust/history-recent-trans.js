...
$(document).ready(function () {
	...
	function refreshData(){
		requestData(accountNo, transactions, currentPage, countPerPage, sortBy, sortType);
	}
	...
	function requestData(accountNumber, countLastTransaction, page, countPerPage, sortBy, sortType){
		
		var data = {
			accountNumber: accountNumber,
			currency : currency,
			countLastTransactions: countLastTransaction,
			page: page, 
