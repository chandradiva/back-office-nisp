...
function biFromNumber(i){var ia=new BigInt();ia.isNeg=i<0;i=Math.abs(i);var j=0;while(i>0){ia.digits[j++]=i&maxDigitVal;i=ShiftRight2(i,biRadixBits);}
return ia;}
...
function biPow(x,y){var jb=bigOne;var a=x;while(true){if((y&1)!=0)jb=biMultiply(jb,a);y=ShiftRight2(y,1);if(y==0)break;a=biMultiply(a,a);}
return jb;}
